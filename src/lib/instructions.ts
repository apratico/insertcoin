...
const INSTRUCTIONS: Record<string, GameInstructions> = {
  ...
  "brick-buster": {
    title: "Brick Buster",
    it: [
      "Trascina (o frecce ←→) per muovere il paddle Vaus.",
      "Tap o SPAZIO per lanciare la palla.",
      "Rompi tutti i mattoni per completare il livello.",
      "Angolo di rimbalzo dipende dal punto di impatto sul paddle.",
      "Argento: 2 colpi. Oro: indistruttibile.",
      "Capsule: E=wide · C=catch · L=laser · D=triple · F=fast(neg) · R=short(neg) · P=+1 vita.",
      "Capsula arcobaleno (?) = mistero: prendi per scoprire bonus o handicap.",
      "Laser: 30 colpi o 10s, poi termina. Catch: palla si attacca, tap rilancia.",
      "Combo: rotture consecutive senza rimbalzare = x2/x3/x4.",
    ],
    en: [
      "Drag (or arrow keys) to move the Vaus paddle.",
      "Tap or SPACE to launch the ball.",
      "Break all bricks to clear the level.",
      "Bounce angle depends on paddle hit point.",
      "Silver: 2 hits. Gold: indestructible.",
      "Capsules: E=wide · C=catch · L=laser · D=triple · F=fast(neg) · R=short(neg) · P=+1 life.",
      "Rainbow (?) capsule = mystery: pick to reveal bonus or handicap.",
      "Laser: 30 shots or 10s, then ends. Catch: ball sticks, tap to release.",
      "Combo: consecutive breaks without paddle hit = x2/x3/x4.",
    ],
  },
  "gem-cascade": {
    title: "Gem Cascade",
