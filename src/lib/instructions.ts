...
const INSTRUCTIONS: Record<string, GameInstructions> = {
  ...
  "brick-buster": {
    ...
    it: [
      ...
      "Capsule: E=wide · C=catch · L=laser · D=triple ball · F=fast · P=+1 vita.",
      "In laser mode: tap = spara. Catch: la palla si attacca, tap rilancia.",
    ...
    en: [
      ...
      "Capsules: E=wide · C=catch · L=laser · D=triple ball · F=fast · P=+1 life.",
      "Laser mode: tap to fire. Catch: ball sticks, tap to release.",
