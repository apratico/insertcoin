...
const INSTRUCTIONS: Record<string, GameInstructions> = {
  ...
  "brick-buster": {
    ...
    it: [
      ...
      "Mattoni argento: 2 colpi. Mattoni oro: indistruttibili (la palla rimbalza).",
      "Combo: rotture consecutive senza rimbalzare sul paddle = x2/x3/x4.",
      "Round clear = +1 vita. 3 vite iniziali, max 5.",
    ],
    en: [
      ...
      "Silver bricks: 2 hits. Gold bricks: indestructible (ball bounces).",
      "Combo: consecutive breaks without paddle hit = x2/x3/x4.",
      "Round clear = +1 life. 3 lives, max 5.",
    ],
  },
  "gem-cascade": {
    title: "Gem Cascade",
